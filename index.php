...
<head>
    ...
    <title>Gaby Riveron - Stylist</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <i class="fa fa-play-circle"></i> <span class="light">GR</span> Stylist
                </a>
            </div>
        ...
        <div class="intro-body">
            <div class="container">
                <div class="row" style="padding-top: 69px;">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <img src="img/fixhair.png" style="width: 90%;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- About Section -->
    <section id="about" class="container content-section text-center" style="background: url('img/gabyredhair.jpg') top right no-repeat;background-size: contain;">
        <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <div class="row" style="color:black;">
                        <div class="col-lg-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h1 class="panel-title">Haircut</h1>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h1 class="panel-title">Highlights</h1>
                                </div>
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h1 class="panel-title">Color Correction</h1>
                                </div>
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                        ...
                        <div class="col-lg-12">
                            <div class="alert alert-warning">
                                <strong>NOTE: </strong>Prices are shown for short and thin hair. All services include shampoo and express dry.
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
    ...
    <section id="contact" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p><a href="mailto:gabyriveron75@gmail.com"><i class="fa fa-envelope-square fa-4x" aria-hidden="true"></i></a>
                </p>
                <p>Visit my social media to find out what I'm about and how I can help.</p>
                <ul class="list-inline banner-social-buttons">
                    <li>
                        <a href="#" class="btn btn-default btn-lg"><i class="fa fa-twitter-square fa-fw"></i> <span class="network-name">Twitter</span></a>
                    </li>
                    <li>
                        <a href="https://fb.me/gabyriveronstylist" class="btn btn-default btn-lg"><i class="fa fa-facebook-square fa-fw"></i> <span class="network-name">Facebook</span></a>
                    </li>
                    <li>
                        <a href="#" class="btn btn-default btn-lg"><i class="fa fa fa-instagram fa-fw"></i> <span class="network-name">Instagram</span></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <iframe
            frameborder="0" style="width: 100%;height: 490px;border:0;padding-left: 10%;padding-right: 10%; padding-top: 100px;"
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCJmcCfXtsjWunFeUCxV0E8p_e_wzzX-1Y&q=place_id:ChIJQS6nYvHXQIYR2yCRxl0yrnA" allowfullscreen>
        </iframe>
    </div>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; Ricardo Riveron 2017</p>
        </div>
    </footer>
